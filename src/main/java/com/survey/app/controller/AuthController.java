...
import com.survey.app.payload.JwtAuthenticationResponse;
import com.survey.app.payload.SignUpRequest;
import com.survey.app.repository.RoleRepository;
import com.survey.app.repository.UserRepository;
import com.survey.app.security.JwtTokenProvider;
...
public class AuthController {
    ...
    @PostMapping("/signin")
    public ResponseEntity<?> authenticateUser(@RequestParam("username")final String username,@RequestParam("password") String password) {
        ...
        return ResponseEntity.ok(new JwtAuthenticationResponse(jwt,username,user.getRoles().iterator().next().getName().toString()));
    }
